...
pub fn main() !void {
    ...
    var byte_array: [3]u8 = .{ 'h', 'e', 'y' }; // initialize a mutable array of three, single byte (8bit) characters
    byte_array[0] = 'x';
    ...
    var var1: f32 = 0;
    var var2: f32 = 0;
    print("Original values of var1 and var2 are: {d}, {d}\n", .{ var1, var2 });
...
// By default, arguments are passed by value into functions, meaning a *copy* of each argument is created when it's passed into a function
fn pass_by_value_manipulation(a: f32, b: f32) void {
...
fn pass_by_reference_manipulation(a: *f32, b: *f32) void {
